...
urlpatterns = [
    ...
    path("jaypee_photo_enthusiasts_guild/", views.jaypee_photo_enthusiasts_guild, name="jaypee_photo_enthusiasts_guild"),
    path("jhankaarjiit/", views.jhankaarjiit, name="jhankaarjiit"),
    path("jiit_impressions/", views.jiit_impressions, name="jiit_impressions"),
    ...
    path("parola_literaryhub/", views.parola_literaryhub, name="parola_literaryhub"),
    path("radiance_hub/", views.radiance_hub, name="radiance_hub"),
